...
import com.gucardev.mqttpoc.service.impl.MqttMessageHandler;
...
public class MqttServerConfig {
  ...
  public MessageHandler handler(StateService stateService, ObjectMapper mapper) {
    return new MqttMessageHandler(stateService, mapper);
  }
